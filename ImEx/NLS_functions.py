...
def rhs_nonlinear(u,uft, xi,tau,kppa,lap_fac):
...
def run_nls_hyper_example(dt,x,xi,kppa,T,tau,lmda_list,imx,inv_list,u_ini,exact_soln_np=None,dx_soln_jx=None,relax=False,log_errs=False,lap_fac=1.0,num_plots=100):
   ...
   # mass_err_l.append(mass_err)
    ...
    return frames,tt,inv_change_dic,inv_fin,errs,mass_err_l,err_l
...
def run_nls_example(dt,x,xi,kppa,T,imx,inv_list,u_ini,exact_soln_np=None,dx_soln_jx=None,relax=False,log_errs=False,lap_fac=1.0,num_plots=100):
